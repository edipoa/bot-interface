...
function DialogContent({
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      >
        {children}
        <DialogPrimitive.Close className="!absolute !top-4 !right-4 !rounded-full !p-2 !bg-gray-200 dark:!bg-gray-700 hover:!bg-gray-300 dark:hover:!bg-gray-600 !transition-all focus:!ring-2 focus:!ring-blue-500 focus:!ring-offset-2 !outline-none disabled:!pointer-events-none !shadow-sm">
